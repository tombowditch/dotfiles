...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["lualine-lsp-progress"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress",
  ...
  neural = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/neural",
    url = "https://github.com/dense-analysis/neural"
  },
  ["nui.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["oxocarbon.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/oxocarbon.nvim",
  ...
  ["printer.nvim"] = {
    ...
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/printer.nvim",
    url = "https://github.com/rareitems/printer.nvim"
  },
  ["significant.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/significant.nvim",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/vim-be-good",
    url = "https://github.com/ThePrimeagen/vim-be-good"
  },
  ["vim-wakatime"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/vim-wakatime",
    url = "https://github.com/wakatime/vim-wakatime"
  },
  ["which-key.nvim"] = {
    config = { "\27LJ\2\n;\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\14which-key\frequire\0" },
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/which-key.nvim",
